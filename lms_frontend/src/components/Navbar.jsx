  ...
  return (
    <nav className="bg-white dark:bg-slate-800 shadow-sm sticky top-0 z-50 border-b border-slate-100 dark:border-slate-700 transition-colors">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between gap-6">
        {/* Logo - Coursera style */}
        <Link to="/" className="text-2xl font-bold text-primary-500 hover:text-primary-600 dark:text-primary-400 dark:hover:text-primary-300 transition-colors flex-shrink-0">
          LMS
        </Link>
        ...
        <div className="hidden lg:flex items-center gap-6 flex-1">
          {isAuthenticated && user?.role === 'student' && (
            <>
              <Link to="/browse" className="text-slate-700 hover:text-primary-500 dark:text-slate-300 dark:hover:text-primary-400 font-medium text-sm transition-colors">
                Browse
              </Link>
              <Link to="/my-learning" className="text-slate-700 hover:text-primary-500 dark:text-slate-300 dark:hover:text-primary-400 font-medium text-sm transition-colors">
                My Learning
              </Link>
            </>
          )}
        ...
        <div className="flex items-center gap-4 flex-shrink-0">
          ...
          >
            {theme === 'light' ? (
              ...
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3v1m0 16v1m8.66-11.66l-.71.71M5.05 18.95l-.71.71M18.36 5.64l-.71-.71M5.05 5.05l.71.71M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
              </svg>
            )}
          </button>
          ...
          {!isAuthenticated ? (
            <>
              <Link to="/login" className="text-slate-700 hover:text-primary-500 dark:text-slate-300 dark:hover:text-primary-400 font-medium text-sm transition-colors">
                Log In
              </Link>
            ...
            <>
              {user?.role === 'teacher' && (
                <>
                  <Link to="/teacher/dashboard" className="text-slate-700 hover:text-primary-500 dark:text-slate-300 dark:hover:text-primary-400 font-medium text-sm transition-colors">
                    Dashboard
                  </Link>
                  <Link to="/teacher/analytics" className="text-slate-700 hover:text-primary-500 dark:text-slate-300 dark:hover:text-primary-400 font-medium text-sm transition-colors">
                    Analytics
                  </Link>
                </>
              )}
              {user?.role === 'student' && (
                <Link to="/cart" className="relative text-slate-700 hover:text-primary-500 dark:text-slate-300 dark:hover:text-primary-400 transition-colors">
