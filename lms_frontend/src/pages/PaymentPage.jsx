    ...
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-slate-600 dark:text-slate-400">Loading payment page...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm">
              <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-4">Course Summary</h2>
              ...
              {course?.subtitle && (
                <p className="text-slate-600 dark:text-slate-400 mb-4">{course.subtitle}</p>
              )}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm sticky top-4">
              ...
              <div className="mb-6 space-y-3">
                ...
                {mode === 'audit' && (
                  <div className="border-t border-slate-200 dark:border-slate-700 pt-3 flex justify-between text-lg font-bold text-emerald-600">
                    <span>Total</span>
                    <span>Free</span>
                  </div>
                )}
