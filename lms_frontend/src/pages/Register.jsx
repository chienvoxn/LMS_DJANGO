      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border-2 border-slate-200 dark:border-slate-700 p-10 w-full max-w-lg space-y-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label
              htmlFor="full_name"
              className="block text-base font-bold text-slate-900 dark:text-slate-100 mb-3"
            >
              Full Name
            </label>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <select
                ...
                value={formData.role}
                onChange={handleChange}
                className="w-full border-2 border-slate-300 dark:border-slate-600 rounded-lg pl-12 pr-4 py-3.5 text-base focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition appearance-none bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100"
              >
