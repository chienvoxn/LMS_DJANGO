  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-white via-slate-50 to-white dark:from-slate-900 dark:via-slate-900 dark:to-slate-900">
        {/* Header Skeleton */}
        <div className="bg-white dark:bg-slate-800 border-b-2 border-slate-200 dark:border-slate-700 py-12">
        ...
        <div className="max-w-6xl mx-auto px-6 mt-10">
          <div className="h-8 w-40 bg-slate-200 dark:bg-slate-700 rounded animate-pulse mb-6"></div>
          <div className="bg-white dark:bg-slate-800 p-10 border-2 border-slate-200 dark:border-slate-700 rounded-2xl space-y-3">
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-white via-slate-50 to-white dark:from-slate-900 dark:via-slate-900 dark:to-slate-900 flex items-center justify-center">
        <div className="max-w-md w-full bg-white dark:bg-slate-800 rounded-2xl shadow-xl border-2 border-slate-200 dark:border-slate-700 p-10 text-center">
          ...
          <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-3">Instructor Not Found</h2>
    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-slate-50 to-white dark:from-slate-900 dark:via-slate-900 dark:to-slate-900">
      ...
      <div className="max-w-6xl mx-auto px-6 mt-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {/* Average Rating */}
          <div className="bg-white dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm font-semibold text-slate-600 dark:text-slate-400">Average Rating</p>
            </div>
          ...
          <div className="bg-white dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm font-semibold text-slate-600 dark:text-slate-400">Students</p>
            </div>
            <p className="text-4xl font-bold text-slate-900 dark:text-slate-100">
          ...
          <div className="bg-white dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm font-semibold text-slate-600 dark:text-slate-400">Reviews</p>
            </div>
            <p className="text-4xl font-bold text-slate-900 dark:text-slate-100">
          ...
          <div className="bg-white dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm font-semibold text-slate-600 dark:text-slate-400">Courses</p>
            </div>
            <p className="text-4xl font-bold text-slate-900 dark:text-slate-100">
      ...
      {profile.bio && (
        <div className="max-w-6xl mx-auto px-6 mt-10">
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-10 border-2 border-slate-200 dark:border-slate-700 shadow-lg">
      ...
      <div className="max-w-6xl mx-auto px-6 mt-12 mb-16">
        <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-8">Courses taught</h2>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {courses.map((course) => (
              <div
                ...
                className="bg-white dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 rounded-2xl shadow-md overflow-hidden hover:shadow-xl hover:border-primary-200 transition-all cursor-pointer group"
              ...
              >
                ...
                {/* Course Info */}
                <div className="p-5">
                  <h3 className="font-bold text-slate-900 dark:text-slate-100 line-clamp-2 mb-3 min-h-[3rem] text-base group-hover:text-primary-600 transition-colors">
                    {course.title}
                  </h3>
