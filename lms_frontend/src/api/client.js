...
export const coursesAPI = {
  ...
  updateTeacherSection: (id, data) =>
    api.patch(`/teacher/sections/${id}/`, data),
...
// Teacher Quiz and Assignment APIs
export const assessmentsAPI = {
  ...
  updateQuestion: (questionId, data) =>
    api.patch(`/teacher/questions/${questionId}/`, data),

  deleteQuestion: (questionId) =>
    api.delete(`/teacher/questions/${questionId}/`),

  // Choice management
  createChoice: (questionId, data) =>
    api.post(`/teacher/questions/${questionId}/choices/`, data),

  updateChoice: (choiceId, data) =>
    api.patch(`/teacher/choices/${choiceId}/`, data),
  ...
  updateTeacherAssignment: (id, data) =>
    api.patch(`/teacher/assignments/${id}/`, data),
  ...
  gradeSubmission: (id, data) =>
    api.patch(`/teacher/submissions/${id}/grade/`, data),
...
export const studentAssignmentAPI = {
  ...
  // Supports both JSON payload and FormData payload.
  // The request interceptor automatically handles FormData headers.
...
export const reviewsAPI = {
  getCourseRatingSummary: (courseId) =>
    api.get(`/courses/${courseId}/rating-summary/`),
  ...
  upsertCourseReview: (courseId, data) =>
...
export const getMyCertificates = () => api.get("/enrollments/me/certificates/");

// Payment History API
export const getPaymentHistory = () => api.get("/enrollments/me/payments/");

// Teacher Analytics APIs
export const getTeacherSummary = () => api.get("/teacher/analytics/summary/");

export const getTeacherCourseStats = () =>
  api.get("/teacher/analytics/courses/");

export const getTeacherEngagement = () =>
  api.get("/teacher/analytics/engagement/");

export const getTeacherTimeseries = (months = 6) =>
  api.get("/teacher/analytics/timeseries/", {
    params: {
      months,
    },
  });
...
export const getTopInstructors = (sort = "students") =>
...
export const getInstructorProfile = (id) =>
  api.get(`/users/instructors/${id}/profile/`);

// Cart APIs
export const getCart = () => api.get("/enrollments/cart/");

export const addToCart = (courseId) =>
  api.post("/enrollments/cart/add/", {
    course_id: courseId,
  });

export const removeCartItem = (itemId) =>
  api.delete(`/enrollments/cart/items/${itemId}/`);
